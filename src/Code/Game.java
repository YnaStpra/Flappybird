...
public class Game extends JPanel implements Runnable, MouseListener{
    ...
    public void start(){
        try{
            ...
            BufferedImage fly = ImageIO.read(getClass().getResource("/Assets/flappy.png"));
            ...
            startPositionFlappy();
            font = new Font("TimesRoman", Font.BOLD, 12 * DISTORTION);
    ...
    public void draw(){
        ...
        if(!inGame)
            g2.drawString("High Record " + record, 10, 35);
        else
            g2.drawString(point + " ", SIZE - 30, 35);
